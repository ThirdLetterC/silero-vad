...
static_assert(sizeof(wav_header_t) == 44, "wav_header_t must match 44-byte WAV header");
...
[[nodiscard]] bool wav_writer_write(const wav_writer_t* writer, const char* filename);
